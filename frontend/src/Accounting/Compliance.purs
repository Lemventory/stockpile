...
import Accounting.CashRegister (RegisterError(..))
...
checkCustomerEligibility :: 
  UUID -> -- Customer ID
  Maybe String -> -- ID document
  Maybe Boolean -> -- Is medical patient
  UUID -> -- Employee verifying
...
checkPurchaseLimits :: 
  UUID -> -- Customer ID
  Array TransactionItem -> -- Current transaction items
...
generateProductLabel menuItem batchId = do
  ...
  let 
    label = 
      ...
      "THC: " <> menuItem.strain_lineage.thc <> "\n" <>
      "CBD: " <> menuItem.strain_lineage.cbg <> "\n" <>
      "Batch: " <> batchId <> "\n" <>
